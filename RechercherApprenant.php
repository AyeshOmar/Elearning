...
$sql="select id ,nom, prènom, username,password,etat_compte,date_dadhésion from apprenant WHERE  id=$inputID";
  ...
  <tr>
    ...
    echo"</td>
        <td>
            ...
            <a class='btn btn-info' href='DetailApprenant.php?id=$row[id]'>Détail</a>
        </td>
    </tr>";
}
?> 
